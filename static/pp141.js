...
// var x =document.getElementById('words').text()
// newURL = 'http://localhost:5000/word';
// fetch(newUrl,{
//     method:"POST",
//     body:x
// });
 ...
 var url = URL.createObjectURL(blob);
    ...
    var node3 = document.createTextNode('View Accuracy');
 ...
 // var node2 = document.createTextNode(serve);
